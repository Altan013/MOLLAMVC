    ...
    public class CategoryController : Controller
    {
        ...
        public IActionResult Edit(Category category)
        {
            ...
            if (category.ImageFile != null)
            {
                ...
                FinalBack.Helpers.Helper.DeleteImg(env.WebRootPath, "assets/images/category", existed.Image);
            ...
            if (category.SizeGuideFile != null)
            {
                ...
                FinalBack.Helpers.Helper.DeleteImg(env.WebRootPath, "assets/images/category", existed.SizeGuideImage);
