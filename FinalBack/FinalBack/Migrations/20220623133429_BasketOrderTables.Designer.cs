...
namespace FinalBack.Migrations
{
    ...
    [Migration("20220623133429_BasketOrderTables")]
    partial class BasketOrderTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalBack.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBack.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBack.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBack.Models.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBack.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBack.Models.Order", b =>
                {
                    ...
                    b.HasOne("FinalBack.Models.Status", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FinalBack.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("FinalBack.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("FinalBack.Models.WishlistItem", b =>
                {
                    ...
                    b.HasOne("FinalBack.Models.ProductColor", "ProductColor")
                        .WithMany()
