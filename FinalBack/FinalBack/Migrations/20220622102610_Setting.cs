        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneIcon = table.Column<string>(maxLength: 50, nullable: false),
                    UserIcon = table.Column<string>(maxLength: 50, nullable: false),
                    LittleWishlist = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
