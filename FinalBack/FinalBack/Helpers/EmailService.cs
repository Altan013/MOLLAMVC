...
namespace FinalBack.Helpers
{
...

    {
...

        {
            ...
            emailMessage.From.Add(new MailboxAddress("Molla", "mollamvc1@gmail.com"));
...

            {
                ...
                await client.AuthenticateAsync("mollamvc1@gmail.com", "ogpriiimspwvlmsc");
